sap.ui.define([
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("Qmnum").length, 1, "The sorting by Qmnum returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by Qmnum and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("Qmnum");
